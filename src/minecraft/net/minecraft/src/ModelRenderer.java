...
public class ModelRenderer {
	...
	public void addBox(float f, float f1, float f2, int i, int j, int k,
		...
		faces[0] = new TexturedQuad(new PositionTextureVertex[] {
				...
				textureOffsetX + k + i, textureOffsetY + k, textureOffsetX + k
						+ i + k, textureOffsetY + k + j, scalex, scaley);
		...
		faces[5] = new TexturedQuad(new PositionTextureVertex[] {
				...
				positiontexturevertex6, positiontexturevertex7 },
				textureOffsetX + k + i + k, textureOffsetY + k, textureOffsetX
						+ k + i + k + i, textureOffsetY + k + j, scalex, scaley);
		if (mirror) {
