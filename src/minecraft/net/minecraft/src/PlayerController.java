...
public class PlayerController {
	...
	public boolean sendPlaceBlock(EntityPlayer entityplayer, World world,
		...
		if (i1 > 0
				&& Block.blocksList[i1].blockActivated(world, i, j, k,
						entityplayer)) {
			return true;
		}
		if (itemstack == null) {
	...
	public ItemStack func_27174_b(int i, int j, int k, boolean flag,
			EntityPlayer entityplayer) {
		return entityplayer.craftingInventory.inventoryClick(j, k, flag,
				entityplayer);
	}
