...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        addRecipe(new ItemStack(Item.paper, 1), new Object[] {
        ...
        addRecipe(new ItemStack(Block.jukebox, 1), new Object[] {
            "#O#", "#X#", "###", Character.valueOf('#'), Block.planks, Character.valueOf('X'), NFC.ruby, 
            Character.valueOf('O'), NFC.brass});
        addRecipe(new ItemStack(Block.musicBlock, 1), new Object[] {
            "###", "#X#", "###", Character.valueOf('#'), Block.planks, Character.valueOf('X'), Item.redstone
        });
        addRecipe(new ItemStack(Block.bookShelf, 2), new Object[] {
        ...
        addRecipe(new ItemStack(Item.sign, 2), new Object[] {
        ...
        addRecipe(new ItemStack(Block.rail, 24), new Object[] {
        ...
        addRecipe(new ItemStack(Block.railPowered, 8), new Object[] {
            "X#X", "I#I", "XRX", Character.valueOf('X'), Item.ingotIron, Character.valueOf('R'), Item.redstone, Character.valueOf('#'), Item.stick, 
            Character.valueOf('I'), NFC.copper
        });
        addRecipe(new ItemStack(Block.railDetector, 8), new Object[] {
            "XOX", "X#X", "XRX", Character.valueOf('X'), Item.ingotIron, Character.valueOf('R'), Item.redstone, Character.valueOf('#'), Block.pressurePlateStone, Character.valueOf('O'), Item.stick
        });
        ...
        addRecipe(new ItemStack(Item.flintAndSteel, 1), new Object[] {
            "A ", " B", Character.valueOf('A'), NFC.steel, Character.valueOf('B'), Item.flint
        });
        ...
        addRecipe(new ItemStack(Item.pocketSundial, 1), new Object[] {
            " # ", "#X#", " # ", Character.valueOf('#'), NFC.brass, Character.valueOf('X'), Item.redstone
        });
        addRecipe(new ItemStack(Item.compass, 1), new Object[] {
            " # ", "#X#", " # ", Character.valueOf('#'), NFC.tin, Character.valueOf('X'), Item.redstone
        });
