...
public class EntityPlayerSP extends EntityPlayer {
	...
	public EntityPlayerSP(Minecraft minecraft, World world, Session session,
		...
		if (session != null && session.username != null
				&& session.username.length() > 0 && session.getProfile().getId() != null) {
			mc.skins.getSkin(session.getProfile(), this);
		}
	...
	public void displayGUIBookshelf(TileEntityBookshelf iinventory) {
		mc.displayGuiScreen(new GuiBookshelf(inventory, iinventory));
	}
	...
	public void displayGUIBook(ItemStack par1ItemStack, boolean par1) {
		mc.displayGuiScreen(new GuiScreenBook(this, this.inventory
				.getCurrentItem(), par1));
	}
	...
	public void displayGUIBrickOven(TileEntityBrickOven tileentityfurnace) {
		mc.displayGuiScreen(new GuiBrickOven(inventory, tileentityfurnace));
	}
