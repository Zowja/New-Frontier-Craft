...
public class EntityOtherPlayerMP extends EntityPlayer {
	...
	public EntityOtherPlayerMP(World world, String s, UUID uuid) {
		super(world);
		field_20924_a = 0.0F;
		username = s;
		yOffset = 0.0F;
		stepHeight = 0.0F;
		if (s != null && s.length() > 0 && uuid != null) {
			SkinManager.getSkin(new GameProfile(uuid, username), this);
		}
		noClip = true;
		field_22062_y = 0.25F;
	...
	public void onLivingUpdate() {
		...
		if (field_785_bg > 0) {
			...
			rotationPitch += (field_786_bl - (double) rotationPitch)
					/ (double) field_785_bg;
			field_785_bg--;
			setPosition(d, d1, d2);
