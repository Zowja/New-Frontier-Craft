    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for (int k2 = 0; k2 < 2; k2++){
			int k4 = k + field_28087_j.nextInt(16);
			int l7 = field_28087_j.nextInt(128);
			int i11 = l + field_28087_j.nextInt(16);
		(new WorldGenMinableCloud(NFC.pebble.blockID, 10, 2, 80)).generate(field_28081_p,
				field_28087_j, k4, l7, i11);
		}
		{
			int i6 = k + field_28087_j.nextInt(16);
			int j9 = field_28087_j.nextInt(128);
			int i12 = l + field_28087_j.nextInt(16);
			(new WorldGenMinable(NFC.pebble.blockID, 32)).generate(field_28081_p,
					field_28087_j, i6, j9, i12);
		}
        ...
        for(int j3 = 0; j3 < 5; j3++)
        {
            ...
            int l9 = field_28087_j.nextInt(128);
        ...
        for(int k3 = 0; k3 < 5; k3++)
        {
            ...
            int i10 = field_28087_j.nextInt(128);
        ...
        for(int k3 = 0; k3 < 5; k3++)
        {
            ...
            int i10 = field_28087_j.nextInt(128);
            int k14 = l + field_28087_j.nextInt(16);
            (new WorldGenMinable(NFC.silverore.blockID, 8)).generate(field_28081_p, field_28087_j, l6, i10, k14);
        }

        for(int l3 = 0; l3 < 5; l3++)
        {
            int i7 = k + field_28087_j.nextInt(16);
            int j10 = field_28087_j.nextInt(128);
        ...
        for(int i4 = 0; i4 < 1; i4++)
        {
            ...
            int k10 = field_28087_j.nextInt(128);
            int i15 = l + field_28087_j.nextInt(16);
            (new WorldGenMinable(Block.oreDiamond.blockID, 1)).generate(field_28081_p, field_28087_j, j7, k10, i15);
        }

        for(int j4 = 0; j4 < 2; j4++)
        {
            int k7 = k + field_28087_j.nextInt(16);
            int l10 = field_28087_j.nextInt(128);
        ...
        
        {
            ...
            int k10 = field_28087_j.nextInt(128);
            int i15 = l + field_28087_j.nextInt(16);
            (new WorldGenMinable(NFC.rubyore.blockID, 1)).generate(field_28081_p, field_28087_j, j7, k10, i15);
        }
		
        {
            ...
            int k10 = field_28087_j.nextInt(128);
            int i15 = l + field_28087_j.nextInt(16);
            (new WorldGenMinable(NFC.emeraldore.blockID, 1)).generate(field_28081_p, field_28087_j, j7, k10, i15);
        }
		
        {
            ...
            int k10 = field_28087_j.nextInt(128);
            int i15 = l + field_28087_j.nextInt(16);
            (new WorldGenMinable(NFC.sapphireore.blockID, 1)).generate(field_28081_p, field_28087_j, j7, k10, i15);
        }
        ...
        structures.generate(field_28081_p, field_28087_j, k, 3, l);
