...
public class Material {
	...
	public static final Material oil;
	...
	static {
		...
		oil = (new MaterialLiquid(MapColor.oilColor)).setNoPushMobility();
		...
		cactus = (new Material(MapColor.foliageColor)).setIsTranslucent()
				.setNoPushMobility();
		...
		field_31068_A = (new Material(MapColor.clothColor)).setNoHarvest()
				.setNoPushMobility();
