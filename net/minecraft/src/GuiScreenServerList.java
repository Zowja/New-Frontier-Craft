...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.clear();
        controlList.add(new GuiButton(0, width / 2 - 100, height / 4 + 96 + 12, stringtranslate.translateKey("Join Server")));
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawCenteredString(fontRenderer, stringtranslate.translateKey("Direct Connection"), width / 2, (height / 4 - 60) + 20, 0xffffff);
        drawString(fontRenderer, stringtranslate.translateKey("Server Address"), width / 2 - 100, 100, 0xa0a0a0);
