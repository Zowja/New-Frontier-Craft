...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void generateTerrain(int i, int j, byte abyte0[],
			BiomeGenBase abiomegenbase[], double ad[]) {
		byte byte0 = 4;
		byte byte1 = 64;
		int k = byte0 + 1;
		byte byte2 = 17;
		int l = byte0 + 1;
		field_4180_q = func_4061_a(field_4180_q, i * byte0, 0, j * byte0, k,
				byte2, l);
		for (int i1 = 0; i1 < byte0; i1++) {
			for (int j1 = 0; j1 < byte0; j1++) {
				for (int k1 = 0; k1 < 16; k1++) {
					double d = 0.125D;
					double d1 = field_4180_q[((i1 + 0) * l + (j1 + 0)) * byte2
							+ (k1 + 0)];
					double d2 = field_4180_q[((i1 + 0) * l + (j1 + 1)) * byte2
							+ (k1 + 0)];
					double d3 = field_4180_q[((i1 + 1) * l + (j1 + 0)) * byte2
							+ (k1 + 0)];
					double d4 = field_4180_q[((i1 + 1) * l + (j1 + 1)) * byte2
							+ (k1 + 0)];
					double d5 = (field_4180_q[((i1 + 0) * l + (j1 + 0)) * byte2
							+ (k1 + 1)] - d1)
							* d;
					double d6 = (field_4180_q[((i1 + 0) * l + (j1 + 1)) * byte2
							+ (k1 + 1)] - d2)
							* d;
					double d7 = (field_4180_q[((i1 + 1) * l + (j1 + 0)) * byte2
							+ (k1 + 1)] - d3)
							* d;
					double d8 = (field_4180_q[((i1 + 1) * l + (j1 + 1)) * byte2
							+ (k1 + 1)] - d4)
							* d;
	...
	public void replaceBlocksForBiome(int i, int j, byte abyte0[],
		...
		byte byte0 = 64;
		double d = 0.03125D;
		sandNoise = field_909_n.generateNoiseOctaves(sandNoise, i * 16, j * 16,
				0.0D, 16, 16, 1, d, d, 1.0D);
		gravelNoise = field_909_n.generateNoiseOctaves(gravelNoise, i * 16,
				109.0134D, j * 16, 16, 1, 16, d, 1.0D, d);
		stoneNoise = field_908_o.generateNoiseOctaves(stoneNoise, i * 16,
				j * 16, 0.0D, 16, 16, 1, d * 2D, d * 2D, d * 2D);
		for (int k = 0; k < 16; k++) {
			for (int l = 0; l < 16; l++) {
				BiomeGenBase biomegenbase = abiomegenbase[k + l * 16];
				boolean flag = sandNoise[k + l * 16] + rand.nextDouble()
						* 0.20000000000000001D > 0.0D;
				boolean flag1 = gravelNoise[k + l * 16] + rand.nextDouble()
	...
	private double[] func_4061_a(double ad[], int i, int j, int k, int l,
			int i1, int j1) {
		if (ad == null) {
		...
		field_4182_g = field_922_a.func_4109_a(field_4182_g, i, k, l, j1,
				1.121D, 1.121D, 0.5D);
		field_4181_h = field_921_b.func_4109_a(field_4181_h, i, k, l, j1, 200D,
				200D, 0.5D);
		field_4185_d = field_910_m.generateNoiseOctaves(field_4185_d, i, j, k,
				l, i1, j1, d / 80D, d1 / 160D, d / 80D);
		field_4184_e = field_912_k.generateNoiseOctaves(field_4184_e, i, j, k,
				l, i1, j1, d, d1, d);
		field_4183_f = field_911_l.generateNoiseOctaves(field_4183_f, i, j, k,
				l, i1, j1, d, d1, d);
		int k1 = 0;
		int l1 = 0;
		int i2 = 16 / l;
	...
	public void populate(IChunkProvider ichunkprovider, int i, int j) {
		...
		for (int j2 = 0; j2 < 20; j2++) {
			...
			(new WorldGenMinable(Block.dirt.blockID, 32)).generate(worldObj,
					rand, l5, i9, l11);
		}
		int joe = 4;
		if (biomegenbase == BiomeGenBase.desert) joe = 1;
		...
		for (int k2 = 0; k2 < 8; k2++) {
			...
			(new WorldGenMinable(Block.gravel.blockID, 32)).generate(worldObj,
					rand, i6, j9, i12);
		}
		...
		(new WorldGenMinableCloud(NFC.pebble.blockID, 10, 2, 80)).generate(worldObj,
				rand, k4, l7, i11);
		}
		{
			int i6 = k + rand.nextInt(16);
			int j9 = rand.nextInt(128);
			int i12 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.pebble.blockID, 32)).generate(worldObj,
					rand, i6, j9, i12);
		}
		}
		{
			...
			int i12 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.mountainore.blockID, 1)).generate(worldObj,
					rand, i6, j9, i12);
		}
		
		{
			...
			if (p <= 3) {
				...
				(new WorldGenMinable(Block.oreDiamond.blockID, 8)).generate(
						worldObj, rand, i4, j7, k10);
			}
			else if (p == 4) {
				int k4 = k + rand.nextInt(16);
				int l7 = rand.nextInt(12);
				int i11 = l + rand.nextInt(16);
				(new WorldGenMinable(NFC.osmiumore.blockID, 9)).generate(worldObj,
						rand, k4, l7, i11);
			}
			}
		...
		{
			int k4 = k + rand.nextInt(16);
			int l7 = rand.nextInt(100);
			int i11 = l + rand.nextInt(16);
		(new WorldGenConcentrated(Block.oreCoal.blockID, 8, 2, 16)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(2) == 1) {
			...
			(new WorldGenMinable(Block.oreLapis.blockID, 6)).generate(
					worldObj, rand, j4, k7, l10);
		}
		...
		for (int k2 = 0; k2 < 3; k2++) {
			...
			(new WorldGenMinable(Block.oreRedstone.blockID, 7)).generate(
					worldObj, rand, l3, i7, j10);
		}
		...
		if (rand.nextInt(8) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.aluminumore.blockID, 8, 2, 90)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		for (int k2 = 0; k2 < (3+rand.nextInt(2)); k2++){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.tinore.blockID, 5)).generate(worldObj,
				rand, k4, l7, i11);
		}
		
		{
			...
			int l7 = rand.nextInt(50);
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.zincore.blockID, 10)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(6) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.leadore.blockID, 12)).generate(worldObj,
					rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(8) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.bismuthore.blockID, 15)).generate(
					worldObj, rand, k4, l7, i11);
		}

		{
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.copperore.blockID, 4, 1, 16)).generate(worldObj,
				rand, k4, l7, i11);
		}
		}
		...
		if (rand.nextInt(4) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.copperore.blockID, 5, 1, 40)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(40) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(Block.oreGold.blockID, 10, 0, 40)).generate(worldObj,
				rand, k4, l7, i11);
		}
		
		if (rand.nextInt(20) == 1){
			int k4 = k + rand.nextInt(16);
			int l7 = rand.nextInt(28)+4;
			int i11 = l + rand.nextInt(16);
		(new WorldGenConcentrated(NFC.anthraciteore.blockID, 10, 3, 10)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(5) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.boronore.blockID, 4, 0, 10)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(16) == 1){
			...
			int l7 = rand.nextInt(50);
			int i11 = l + rand.nextInt(16);
		(new WorldGenConcentrated(NFC.silverore.blockID, 12, 6, 8)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(12) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.nickelore.blockID, 6, 4, 24)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(20) == 1) {
			...
			int l7 = rand.nextInt(40);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.platinumore.blockID, 18)).generate(
					worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(42) <= 2){
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(Block.oreIron.blockID, 16, 2, 200)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(16) == 1){
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.cobaltore.blockID, 16)).generate(worldObj,
					rand, k4, l7, i11);
		}
		
		if (rand.nextInt(5) == 1){
			int k4 = k + rand.nextInt(16);
			int l7 = rand.nextInt(20);
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.chromeore.blockID, 10)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(15) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.siliconore.blockID, 5, 4, 15)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(25) == 1){
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinableCloud(NFC.titaniumore.blockID, 8, 3, 25)).generate(worldObj,
				rand, k4, l7, i11);
		}
		
		{
			...
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.tungstenore.blockID, 1)).generate(worldObj,
				rand, k4, l7, i11);
		}
		
		{
			...
			(new WorldGenMinable(NFC.FakeBedrock.blockID, 1)).generate(
					worldObj, rand, i3, j6, k9);
		}
		...
		if (rand.nextInt(32) == 1) {
			...
			int l7 = rand.nextInt(32);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.uranite.blockID, 16)).generate(worldObj,
					rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(10) == 1) {
			...
			int l7 = rand.nextInt(32);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(NFC.magnititeore.blockID, 5)).generate(worldObj,
					rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1){
			...
			int l7 = rand.nextInt(16);
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.rubyore.blockID, 1)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1){
			...
			int l7 = rand.nextInt(16);
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.emeraldore.blockID, 1)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1){
			...
			int l7 = rand.nextInt(16);
			int i11 = l + rand.nextInt(16);
		(new WorldGenMinable(NFC.sapphireore.blockID, 1)).generate(worldObj,
				rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(16) == 1) {
			...
			int i8 = l + rand.nextInt(16) + 8;
			(new WorldGenLakes(NFC.OilStill.blockID)).generate(worldObj,
					rand, i1, l4, i8);
		}
		...
		d = 0.5D;
		k4 = (int) ((mobSpawnerNoise.func_806_a((double) k * d, (double) l * d)
		...
		if (biomegenbase == BiomeGenBase.alpha) {
			l7 += k4 + rand.nextInt(rand.nextInt(rand.nextInt(5)+1)+1);
		}
		...
		for (i11 = 0; i11 < l7; i11++) {
			...
			WorldGenerator worldgenerator = biomegenbase
					.getRandomWorldGenForTrees(rand);
			worldgenerator.func_517_a(1.0D, 1.0D, 1.0D);
			worldgenerator.generate(worldObj, rand, j12,
					worldObj.getHeightValue(j12, l12), l12);
		}
		...
		for (int k12 = 0; k12 < i11; k12++) {
			...
			(new WorldGenFlowers(Block.plantYellow.blockID)).generate(worldObj,
					rand, i13, j15, i18);
		}
		...
		for (int j13 = 0; j13 < byte0; j13++) {
			...
			(new WorldGenTallGrass(Block.tallGrass.blockID, byte1)).generate(
					worldObj, rand, j18, i21, l22);
		}
		...
		for (int k13 = 0; k13 < byte0; k13++) {
			...
			(new WorldGenDeadBush(Block.deadBush.blockID)).generate(worldObj,
					rand, k15, k18, j21);
		}
		...
		if (rand.nextInt(2) == 0) {
			...
			(new WorldGenFlowers(Block.plantRed.blockID)).generate(worldObj,
					rand, l13, l15, l18);
		}
		if (rand.nextInt(4) == 0) {
		...
		if (rand.nextInt(32) == 0) {
			...
			int j19 = l + rand.nextInt(16) + 8;
			(new WorldGenFlowers(NFC.biolumMushroom.blockID)).generate(worldObj,
					rand, j14, j16, j19);
		}
		if(biomegenbase == BiomeGenBase.seasonalForest){
		...
		for (int j17 = 0; j17 < 50; j17++) {
			...
			(new WorldGenLiquids(Block.waterMoving.blockID)).generate(worldObj,
					rand, j20, i22, j23);
		}
		...
		for (int k17 = 0; k17 < 20; k17++) {
			...
			(new WorldGenLiquids(Block.lavaMoving.blockID)).generate(worldObj,
					rand, k20, j22, k23);
		}
		(new WorldStructureCommon()).WorldGen(biomegenbase,worldObj, rand, k, l);
		
		generatedTemperatures = worldObj.getWorldChunkManager()
				.getTemperatures(generatedTemperatures, k + 8, l + 8, 16, 16);
		for (int l17 = k + 8; l17 < k + 8 + 16; l17++) {
			for (int l20 = l + 8; l20 < l + 8 + 16; l20++) {
				int k22 = l17 - (k + 8);
				int l23 = l20 - (l + 8);
				int i24 = worldObj.findTopSolidBlock(l17, l20);
				double d1 = generatedTemperatures[k22 * 16 + l23]
						- ((double) (i24 - 64) / 64D) * 0.29999999999999999D;
				if (d1 < 0.5D
						&& i24 > 0
						&& i24 < 128
						&& worldObj.isAirBlock(l17, i24, l20)
						&& worldObj.getBlockMaterial(l17, i24 - 1, l20)
								.getIsSolid()
						&& worldObj.getBlockMaterial(l17, i24 - 1, l20) != Material.ice) {
					worldObj.setBlockWithNotify(l17, i24, l20,
							Block.snow.blockID);
				}
			}
