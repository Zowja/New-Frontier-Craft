...
public class RecipesIngots
{
    ...
    public RecipesIngots()
    {
        recipeItems = (new Object[][] {
            new Object[] {
                Block.blockGold, new ItemStack(Item.ingotGold, 4)
            }, new Object[] {
                Block.blockSteel, new ItemStack(Item.ingotIron, 4)
            }, new Object[] {
                Block.blockDiamond, new ItemStack(Item.diamond, 4)
            }, new Object[] {
                Block.blockLapis, new ItemStack(Item.dyePowder, 4, 4)
            }
        });
    }
