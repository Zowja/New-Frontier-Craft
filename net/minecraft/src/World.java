    ...
    implements IBlockAccess
{
    ...
    public int getBlockLightValue_do(int i, int j, int k, boolean flag)
    {
        ...
        {
            int l = getBlockId(i, j, k);
            if(l == Block.stairSingle.blockID || l == NFC.SidewaysStep.blockID || l == Block.tilledField.blockID || l == Block.stairCompactCobblestone.blockID || l == Block.stairCompactPlanks.blockID)
            {
