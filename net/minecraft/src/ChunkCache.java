    ...
    implements IBlockAccess
{
    ...
    public int getLightValueExt(int i, int j, int k, boolean flag)
    {
        ...
        if(flag)
        {
            ...
            if(l == Block.stairSingle.blockID || l == NFC.SidewaysStep.blockID || l == Block.tilledField.blockID || l == Block.stairCompactPlanks.blockID || l == Block.stairCompactCobblestone.blockID)
            {
