...
public class NFC {
	...
	public static void addRecipies(CraftingManager craftmng) {
		...
		Item.itemsList[SidewaysStep.blockID] = (new ItemSlab(
				SidewaysStep.blockID - 256)).setItemName("Stone Slab");
		...
		craftmng.addRecipe(new ItemStack(Block.portal, 1), new Object[] { "X",
				('X'), Block.dirt });
		
		craftmng.addRecipe(new ItemStack(SidewaysStep, 6, 0), new Object[] {
	            "#", "#", "#", Character.valueOf('#'), Block.stone
	        });
		
		craftmng.addRecipe(new ItemStack(SidewaysStep, 6, 1), new Object[] {
	            "#", "#", "#", Character.valueOf('#'), Block.sandStone
	        });
		
		craftmng.addRecipe(new ItemStack(SidewaysStep, 6, 2), new Object[] {
	            "#", "#", "#", Character.valueOf('#'), Block.planks
	        });
		
		craftmng.addRecipe(new ItemStack(SidewaysStep, 6, 3), new Object[] {
	...
	public static final Block SidewaysStep = (new BlockSidewaysStep(101, false)).setHardness(2.0F)
			.setResistance(10F).setStepSound(Block.soundStoneFootstep)
			.setBlockName("Stone Slab");
	public static final Block DoubleSidewaysStep = (new BlockSidewaysStep(102, true)).setHardness(2.0F)
			.setResistance(10F).setStepSound(Block.soundStoneFootstep)
			.setBlockName("Stone Slab");
	...
	public static final Item WrittenBook = (new ItemWrittenBook(432)
	...
	public static int rawVersion = 18600;
	public static String Version = "New Frontier Craft 1.8.6";
