...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawCenteredString(fontRenderer, stringtranslate.translateKey("Edit Server Info"), width / 2, (height / 4 - 60) + 20, 0xffffff);
        drawString(fontRenderer, stringtranslate.translateKey("Server Name"), width / 2 - 100, 63, 0xa0a0a0);
        drawString(fontRenderer, stringtranslate.translateKey("Server Address"), width / 2 - 100, 104, 0xa0a0a0);
